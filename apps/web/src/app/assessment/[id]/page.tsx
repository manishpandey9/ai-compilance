  ...
  return (
    <PageContainer width="content" className="py-16">
      <main id="main-content">
        ...
        <div className="mt-6 border-y border-zinc-200 py-5 text-sm leading-relaxed text-zinc-600">
          <p>
            This result is generated by deterministic rules, not an LLM. Current rule-backed coverage
            is strongest for HR recruitment, creditworthiness and insurance pricing, chatbot
            transparency, and synthetic-media disclosure.
          </p>
          <p className="mt-3 text-zinc-500">
            Use the paid files as editable evidence-preparation drafts for procurement, counsel,
            auditor, or internal review.
          </p>
        </div>
